...
def main():
    ...
    parser.add_argument('owner', help='github owner', nargs='?', default='KuroShinigami318')
    parser.add_argument('download_folder_name', help='location for downloading scripts', nargs='?', default='scripts')
